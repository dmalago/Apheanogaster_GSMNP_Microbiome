...
plot_diff2 <- plot2 + 
  ...
  facet_grid(~fct_relevel(Group, 'Red','Purple', 'Blue'), scale="free_x", space = "free_x") +
...
pdf(file = "Microshades_Barplot_Without_Wolbachia.pdf", width = 10, height = 6)
plot_grid(plot_diff2, GP_legend_new, rel_widths = c(1, .25))
dev.off()
