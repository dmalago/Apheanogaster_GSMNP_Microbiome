...
Wreads<-otu_table(rMGphylo)[which(tax_table(rMGphylo)[,6]=='Spiroplasma'),]
...
#Define violin plot
p_wolbachia <- ggplot(diversity_df, aes(x=Group, y=Wolbachia)) + geom_violin(aes(fill=Group),scale='width') +labs(x ="Group", y = "Spiroplasma")
